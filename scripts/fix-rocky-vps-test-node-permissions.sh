...
ALTER DEFAULT PRIVILEGES IN SCHEMA dbo GRANT ALL ON TABLES TO rocky;
ALTER DEFAULT PRIVILEGES IN SCHEMA dbo GRANT ALL ON SEQUENCES TO rocky;
ALTER DEFAULT PRIVILEGES IN SCHEMA dbo GRANT ALL ON FUNCTIONS TO rocky;
SQL
done
