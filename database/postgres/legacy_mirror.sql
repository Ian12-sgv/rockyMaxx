...
CREATE TABLE IF NOT EXISTS dbo."DEVBORRADOR" (
  "Numero" bigint NOT NULL,
  "Fecha" timestamp(0) without time zone NOT NULL,
  "Observacion" varchar(250) NOT NULL,
  "Usuario" varchar(15) NOT NULL,
...
ALTER TABLE ONLY dbo."DEVBORRADOR" ADD CONSTRAINT "PK_DEVBORRADOR" PRIMARY KEY ("Numero");
...
ALTER TABLE ONLY dbo."DEVBORRADOR" ADD CONSTRAINT "FK_DEVBORRADOR_USUARIOS" FOREIGN KEY ("Usuario") REFERENCES dbo."USUARIOS" ("CodUsuario") ON DELETE NO ACTION ON UPDATE CASCADE;
...
ALTER TABLE ONLY dbo."MOVDEVBORRADOR" ADD CONSTRAINT "FK_MOVDEVBORRADOR_DEVBORRADOR" FOREIGN KEY ("Numero") REFERENCES dbo."DEVBORRADOR" ("Numero") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE ONLY dbo."MOVDEVBORRADOR" ADD CONSTRAINT "FK_MOVDEVBORRADOR_INVENTARIO" FOREIGN KEY ("CodigoBarra") REFERENCES dbo."INVENTARIO" ("CodigoBarra") ON DELETE NO ACTION ON UPDATE CASCADE;
